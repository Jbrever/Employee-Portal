        ...
        <Card.Body>
          <div className="d-flex flex-wrap gap-6">
            ...
            <div className="relative">
              <div className="w-32 h-32 rounded-circle bg-gray-200 d-flex align-items-center justify-content-center overflow-hidden">
                {profileImage ? (
              ...
              <label className="position-absolute bottom-0 right-0 bg-primary text-white p-2 rounded-circle cursor-pointer">
